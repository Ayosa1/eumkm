...
<section id="protfolio" class="background-cover-fashion" style="margin-top: 50px;">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
...
<div id="content-wrapper">
    <section id="portfolio" class="white" style="margin-top: 50px;">
        <div class="container">
            ...
            <form action="/kategorifashion/cari" method="GET">
                <input type="text" name="carifashion" placeholder="Cari Pegawai .." value="{{ old('cari') }}">
                <input type="submit" value="CARIKULINER">
            </form>
            <div class="gap"></div>   
                <div class="row">
