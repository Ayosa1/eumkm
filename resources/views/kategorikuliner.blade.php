                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="center gap fade-down section-heading">
                                <h2 class="main-title">Kategori Kuliner</h2>
                                <hr>
...
<script>
    function myFunction() {
      alert("Maaf anda harus login atau register dulu untuk masuk halaman ini!");
      location.replace("/register")
    }
    </script>
<section id="protfolio" class="background-cover-kuliner" style="margin-top: 50px;">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
...
<div id="content-wrapper">
    <section id="portfolio" style="margin-top: 50px;" class="white">
        <div class="container">
            <p>Cari Data :</p>
            <form action="/kategorikuliner/cari" method="GET">
                <input type="text" name="carikuliner" placeholder="Cari.." value="{{ old('cari') }}">
                <input type="submit" value="CARI">
            </form>
            <div class="gap"></div>   
                <div class="row">
                    <ul class="portfolio-items col-3 isotope fade-up">
                    @foreach ($kategori_kuliner as $item)
                        <li class="portfolio-item {{ $item->nama_kategori }} apps isotope-item">
                            <div class="item-inner">
                                ...
                                <div class="overlay">
                                    ...
                                    @else{
                                        <a class="preview btn btn-outlined btn-primary"><button onclick="myFunction()" class="btn-sm btn-warning">Lihat Selengkapnya</button></a>
                                    }
                                    @endif
                                </div>
                            </div>
