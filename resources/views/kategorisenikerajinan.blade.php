                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="center gap fade-down section-heading">
                                <h2 class="main-title">Kategori Seni Kerajinan</h2>
                                <hr>
...
<section id="protfolio" class="background-cover-seni" style="margin-top: 50px;">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
...
<div id="content-wrapper">
    <section id="portfolio" class="white" style="margin-top: 50px;">
        <div class="container">
            <p>Cari Data :</p>
            <form action="/kategoriseni/cari" method="GET">
                <input type="text" name="cariseni" placeholder="Cari.." value="{{ old('cari') }}">
                <input type="submit" value="CARI">
            </form>
            <div class="gap"></div>   
                <div class="row">
                    <ul class="portfolio-items col-3 isotope fade-up">
                    @foreach ($kategori_seni as $item)
