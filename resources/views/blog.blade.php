        ...
        <div class="gap"></div>
            <div class="row">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <ul class="arrow">
                                    ...
                                    <li><a href="{{ url('/blogfashion') }}">Fasion</a></li>
                ...
                <div class="col-sm-8 col-sm-pull-4">
                    <div class="blog">
                        @foreach ($blog_umkm as $item)
                        <div class="blog-item">
                            <div class="blog-featured-image">
                                <img  src="{{ asset('/storage/images/foto_blog/'.$item->foto_blog) }}" width="750px" height="500px" alt="" />
                                <div class="overlay">
                            ...
                            <div class="blog-content">
                                ...
                                <div class="read-more-wrapper">
                                    <a class="btn btn-outlined btn-warning" href="{{ url('blogdetail') }}/{{ $item->id_blog }}">Read More</a>
                                </div>
                            </div>
                        </div><!--/.blog-item-->
                        @endforeach
