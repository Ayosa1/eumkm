@extends('admin.master.app', ['title' => 'Edit Staff OKE OC'])
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Edit Staff OKE OC</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Edit Staff OKE OC</li>
            </ol>
          </div>
        </div>
      </div>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Edit Staff OKE OC</h3>
              </div>
              <div class="card-body">
                @foreach ($staff2edit as $item)
            <form action="/admin/user/staff2update/{{$item->id}}" method="POST" autocomplete="off" enctype="multipart/form-data">
                @endforeach   
                <div class="col-md-6">
                    @method('patch')
                    @csrf
