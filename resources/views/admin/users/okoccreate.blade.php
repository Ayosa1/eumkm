@extends('admin.master.app', ['title' => 'Tambah Staff Oke OC'])
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Staff Oke OC</li>
            </ol>
          </div>
        </div>
      </div>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Tambah Staff Oke OC</h3>
              </div>
              <div class="card-body">
                <div class="col-md-6">
                    <form action="storestaff2" method="POST" autocomplete="off" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
