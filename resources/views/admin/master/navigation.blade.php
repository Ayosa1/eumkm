...
<a href="index3.html" class="brand-link">
    <img src="{{url('/storage/images/logo/logo.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
...
<div class="sidebar">
    ...
    <div class="image">
        <img src="{{url('/storage/images/logo/user.png')}}" class="img-circle elevation-2" alt="User Image">
    </div>
    <div class="info">
