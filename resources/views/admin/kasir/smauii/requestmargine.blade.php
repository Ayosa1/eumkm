@extends('admin.master.app', ['title' => 'Request Range Margine'])
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Range Tanggal Margine</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Range Tanggal Margine</li>
            </ol>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="col-md-6">
                    <form action="{{url('/admin/kasirsmauii/rangemargine')}}" method="POST" autocomplete="off" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
