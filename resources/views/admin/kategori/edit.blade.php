@extends('admin.master.app', ['title' => 'Edit Kategori'])
          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="col-md-6">
                  @foreach ($kategoriedit as $kategori)
                  <form action="/admin/kategori/update/{{$kategori->id_kategori}}" method="POST" autocomplete="off" enctype="multipart/form-data">
                    @method('patch')
                    @csrf
                    <div class="card-body">
