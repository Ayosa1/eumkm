              ...
              <div class="col-md-4 col-sm-4" >
                  ...
                  <div class="col-md-4 col-sm-4">
                      <div>
                          <h4>Info</h4>
                          <ul class="arrow">
                              <li><a style="text-decoration: none;" href="#">Tentang Kami</a></li>
                              <li><a style="text-decoration: none;" href="#">Mitra UMKM</a></li>
                              <li><a style="text-decoration: none;" href="#">Blog</a></li>
                              <li><a style="text-decoration: none;" href="#">Gabung</a></li>        
                              <li><a style="text-decoration: none;" href="#">Kontak </a></li>
                          </ul>
                      </div>
                  </div><!--/.col-md-3-->
