...
class AnggotaProdukController extends Controller
{
    ...
    {
        return view('admin.inputmemberproduk.inputproduk1');
    }
    ...
    public function PostProduk1(Request $request)
    {
        ...
        $waktusekarang = time();
        $rand =rand(10, 99);
        $id_produk = $rand.$waktusekarang; 
        $nama_index = $request->nama_index_produk;
        
        $request->session()->put('id_produk', $id_produk);
    ...
    public function PostUmkm1(Request $request)
       {
        ...
        $foto_fix = $nama_produk1.'.'.$nama_foto.'.'.$foto_umkm->extension();
